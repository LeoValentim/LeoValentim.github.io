define([], function() {
    ...
    function appendCars(cars){
        ...
        for (var i = 0; i < cars.length; i++) {
            cardHTML += gernerateCarCard(cars[i]);
        }
        document.querySelector('.mdl-grid').insertAdjacentHTML('beforeend', cardHTML);
        // Force redraw fix for ie
        document.querySelector('.mdl-layout__content').styles.display = 'none';
        document.querySelector('.mdl-layout__content').styles.display = 'inline-block';
    }
